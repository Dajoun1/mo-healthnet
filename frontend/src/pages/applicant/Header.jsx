  ...
  return (
    <section className="bg-[#ffffff] flex flex-col items-center text-center mt-20 px-4 sm:px-6 md:px-8 lg:px-16 py-8 sm:py-12 md:py-16">
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full sm:w-auto mb-10">
        <Link
          to="/signup"
          className="bg-[#0078AE] text-white py-2 px-6 sm:px-8 rounded hover:bg-[#005f8e] transition-colors duration-200 w-full sm:w-auto text-center"
        >
          Apply
        </Link>
        <Link
          to="/signin"
          className="text-stone-900 font-semibold py-2 px-6 sm:px-8 rounded border border-stone-400 hover:border-[#0078AE] hover:text-[#0078AE] transition-colors duration-200 w-full sm:w-auto text-center"
        >
          Sign in
        </Link>
      </div>
